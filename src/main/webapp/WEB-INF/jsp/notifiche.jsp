        ...
        <section class="content">
            ...
            <ul class="lista-notifiche">
                <% for (var notification: notifications) { %>
                    <% var todayNotifications=notifications.stream().filter(todayNotification -> notification.getNotificationDate().toLocalDateTime().getDayOfYear()==LocalDate.now().getDayOfYear()).toList(); %>
                    <% var yesterdayNotifications=notifications.stream().filter(yesterdayNotification -> notification.getNotificationDate().toLocalDateTime().getDayOfYear()==LocalDate.now().getDayOfYear()-1).toList(); %>
                    <li class="giorno"><p>Oggi</p></li>
                    <li class="notif-container">
                    <% for (var n: todayNotifications) { %>
                        <div class="notifica">
                    ...
                    <li class="notif-container">
                        <% for (var n: yesterdayNotifications) { %>
                        <div class="notifica">
                            <% if (!n.isViewed()) { %><a class="da-leggere" href="">
                            <% } else { %><a href=""><% } %>
                            <img src="../../images/propic.jpg" alt="immagine profilo" width="50" height="50"/>
